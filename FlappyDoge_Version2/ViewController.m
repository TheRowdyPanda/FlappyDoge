...
- (void)viewDidLoad
{
   ...
   // skView.showsNodeCount = YES;
    ...
    SKScene * scene = [flappyDogeDebug2 sceneWithSize:skView.bounds.size];
...
//    }
//    else{
//        _adView.frame = CGRectOffset(_adView.frame, 0, 435);
//    }
...
-(void)setUpiAd{
    ...
    if(IsIphone5){
        ...
        _adView.frame = CGRectOffset(_adView.frame, 0, 435*(self.view.frame.size.height/480));
    }
...
- (void)bannerView:(ADBannerView *)banner didFailToReceiveAdWithError:(NSError *)error
{
  ...
  //  _admobBannerView = [[GADBannerView alloc] initWithAdSize:kGADAdSizeBanner];
    ...
    if(IsIphone5){
        _admobBannerView.frame = CGRectOffset(_admobBannerView.frame, 0, 0);
        
    }
    else{
        _admobBannerView.frame = CGRectOffset(_admobBannerView.frame, 0, 435*(self.view.frame.size.height/480));
    }
    
    // 3
    self.admobBannerView.adUnitID = @"ca-app-pub-4658531991803126/2815802092";
...
-(CAEmitterLayer*)addParticleEmitterUnderneathAdd{
    ...
    if(IsIphone5){
        ...
        yPos = 485*(self.view.frame.size.height/480);
    }
